    ...
    <div className="contentHome">
      <div className="text-white text-center">
        ...
        <div className="px-5 pb-32 pt-5 text-left">
          <div className="">公告：新版本即将上线</div>
          <div className="_title text-2xl py-5 Medium">
            全面解析Aleo 帮助大家更深入地认识这个项目
          </div>
          <div className="pb-5">隐私保护/可编程性/可扩展性/合规性/经济模型</div>
          ...
          />
          <div className="_title text-2xl pt-10 pb-5 Medium">隐私保护：</div>
          <div className="pb-2">Aleo采用零知识证明技术</div>
          <div className="text">
            在数字时代，隐私保护成为了人们日益关注的问题。Aleo采用零知识证明技术，确保用户数据在区块链上的安全性和隐私性。这种技术使得用户可以在不透露任何个人信息的情况下进行交易和交互，有效避免了数据泄露的风险
          </div>
          <div className="_title text-2xl pt-10 pb-5 Medium">可编程性：</div>
          <div className="pb-2">ZK在应用栈各层面均可编程</div>
          ...
          <div className="_title text-2xl pt-10 pb-5 Medium">可扩展性：</div>
          <div className="pb-2">以太坊所有的灵活性</div>
          <div className="text pb-5">
          ...
          />
          <div className="_title text-2xl pt-10 pb-5 Medium">合规性：</div>
          <div className="pb-2">Aleo构建了安全、合规和公平的Web标准</div>
          <div className="text pb-5">
          ...
          <div className="_title text-2xl pt-10 pb-5 Medium">经济模型：</div>
          <div className="pb-2">Aleo具备稳定的代币经济和可预测的价格</div>
          <div className="text pb-5">
          ...
          />
          <div className="text-2xl text-center pt-14 pb-5">合作机构</div>
